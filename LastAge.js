/* $Id: LastAge.js,v 1.87 2007/08/31 23:27:32 Jim Exp $ */
...
MN2E.spellsSchools = {
  ...
  'Bigby\'s Clenched Fist':'Greater Evocation',
  'Bigby\'s Crushing Hand':'Greater Evocation',
  'Bigby\'s Forceful Hand':'Greater Evocation',
  'Bigby\'s Grasping Hand':'Greater Evocation',
  'Bigby\'s Interposing Hand':'Greater Evocation',
  'Burial':'Transmutation',
  ...
  'Greenshield':'Illusion',
  'Gust Of Wind':'Greater Evocation',
  'Halfling Burrow':'Transmutation',
  'Hallow':'Greater Evocation',
  'Ice Storm':'Greater Evocation',
  'Insect Plague':'Greater Conjuration',
  'Leomund\'s Secret Chest':'Greater Conjuration',
  'Leomund\'s Tiny Hut':'Greater Evocation',
  'Lesser Planar Binding':'Greater Conjuration',
  'Lie':'Transmutation',
  'Lifetrap':'Transmutation',
  'Lightning Bolt':'Greater Evocation',
  'Magic Circle Against Shadow':'Abjuration',
  'Magic Missile':'Greater Evocation',
  'Meteor Swarm':'Greater Evocation',
  'Mordenkainen\'s Sword':'Greater Evocation',
  'Mount':'Greater Conjuration',
  'Nature\'s Revelation':'Transmutation',
  'Nexus Fuel':'Necromancy',
  'Otiluke\'s Freezing Sphere':'Greater Evocation',
  'Otiluke\'s Resilient Sphere':'Greater Evocation',
  'Otiluke\'s Telekinetic Sphere':'Greater Evocation',
  'Phantom Edge':'Transmutation',
  ...
  'Scryer\'s Mark':'Divination',
  'Shocking Grasp':'Greater Evocation',
  'Silver Blood':'Transmutation',
  'Silver Storm':'Transmutation',
  'Silver Wind':'Conjuration',
  'Stone Soup':'Transmutation',
  ...
  'Tenser\'s Floating Disk':'Greater Evocation',
    ...
    if(klass == 'Barbarian') {
      ...
      if(klass == 'Charismatic Channeler') {
        ...
        notes = notes.concat([
          ...
          'validationNotes.greaterConfidenceSelectableFeatureFeatures:Requires Improved Confidence',
          'validationNotes.greaterFurySelectableFeatureFeatures:Requires Improved Fury',
          'validationNotes.improvedConfidenceSelectableFeatureFeatures:Requires Inspire Confidence',
          'validationNotes.improvedFurySelectableFeatureFeatures:Requires Inspire Fury',
          'validationNotes.massSuggestionSelectableFeatureFeatures:Requires Suggestion',
          'validationNotes.suggestionSelectableFeatureFeatures:Requires Inspire Fascination'
        ]);
        selectableFeatures = [
        ...
        notes = notes.concat([
          ...
          'magicNotes.magecraft(Spiritual)Feature:' +
            '4 spells/%V spell energy points',
          'validationNotes.confidentEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural',
          'validationNotes.heightenedEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural',
          'validationNotes.powerfulEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural',
          'validationNotes.preciseEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural',
          'validationNotes.specificEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural',
          'validationNotes.universalEffectSelectableFeatureFeatures:Requires Mastery Of Nature|Mastery Of Spirits|Mastery Of The Unnatural'
        ]);
        selectableFeatures = [
      ...
      notes = [
        ...
        'validationNotes.counterattackSelectableFeatureFeatures:Requires Dodge Training/Offensive Training',
        'validationNotes.coverAllySelectableFeatureFeatures:Requires Dodge Training',
        'validationNotes.devastatingStrikeSelectableFeatureFeatures:Requires Grappling Training/Offensive Training',
        'validationNotes.furiousGrappleSelectableFeatureFeatures:Requires Grappling Training/Speed Training',
        'validationNotes.oneWithTheWeaponSelectableFeatureFeatures:Requires Offensive Training',
        'validationNotes.rapidStrikeSelectableFeatureFeatures:Requires Speed Training',
        'validationNotes.retaliatoryStrikeSelectableFeatureFeatures:Requires Dodge Training/Speed Training',
        'validationNotes.strikeAndHoldSelectableFeatureFeatures:Requires Grappling Training',
        'validationNotes.weaponTrapSelectableFeatureFeatures:Requires Dodge Training/Grappling Training'
      ];
      profArmor = PH35.PROFICIENCY_NONE;
      profShield = PH35.PROFICIENCY_NONE;
      ...
      notes = [
        ...
        'validationNotes.animalCompanionSelectableFeatureFeatures:Requires Wild Empathy',
        'validationNotes.camouflageSelectableFeatureFeatures:Requires Skill Mastery/Trackless Step',
        'validationNotes.evasionSelectableFeatureFeatures:Requires Quick Stride/Instinctive Response',
        'validationNotes.hatedFoeSelectableFeatureFeatures:Requires Master Hunter',
        'validationNotes.hideInPlainSightSelectableFeatureFeatures:Requires Camouflage',
        'validationNotes.huntedByTheShadowSelectableFeatureFeatures:Requires Rapid Response/Sense Dark Magic',
        'validationNotes.improvedEvasionSelectableFeatureFeatures:Requires Evasion',
        'validationNotes.improvedWoodlandStrideSelectableFeatureFeatures:Requires Woodland Stride/Overland Stride',
        'validationNotes.instinctiveResponseSelectableFeatureFeatures:Requires Rapid Response',
        'validationNotes.overlandStrideSelectableFeatureFeatures:Requires Quick Stride',
        'validationNotes.senseDarkMagicSelectableFeatureFeatures:Requires Master Hunter',
        'validationNotes.slipperyMindSelectableFeatureFeatures:Requires Hunted By The Shadow',
        'validationNotes.tracklessStepSelectableFeatureFeatures:Requires Woodland Stride',
        'validationNotes.trueAimSelectableFeatureFeatures:Requires Skill Mastery/Hated Foe',
        'validationNotes.woodsloreSelectableFeatureFeatures:Requires Wilderness Trapfinding'
      ];
  ...
  for(var i = 0; i < allFeats.length; i++) {
    ...
    if(feat == 'Craft Charm') {
      ...
      notes = [
        ...
        'validationNotes.craftGreaterSpellTalismanFeatFeats:Requires Max Magecraft >= 1/Ritual Magic/any 2 Spellcasting',
        'validationNotes.craftGreaterSpellTalismanFeatLevel:Requires Level >= 12'
      ];
      ...
      notes = [
        ...
        'validationNotes.craftSpellTalismanFeatFeats:Requires Max Magecraft >= 1/Max Spellcasting >= 1',
      ...
      notes = [
       ...
       'validationNotes.devastatingMountedAssaultFeatFeats:Requires Mounted Combat',
      ...
      notes = [
        ...
        'validationNotes.extraGiftFeatLevels:Requires Charismatic Channeler >= 4|Spiritual Channeler >= 4'
      ];
      rules.defineRule('combatNotes.masterOfTwoWorldsFeature',
      ...
      notes = [
        ...
        'validationNotes.friendlyAgentFeatRace:Requires Race==Gnome|Race==Dorn|Race==Erenander|Race=~Sarcosan'
      ];
    } else if(feat == 'Giant Fighter') {
      notes = [
        'combatNotes.giantFighterFeature:' +
          '+4 AC/double critical range w/in 30 ft vs. giants',
        'validationNotes.giantFighterFeatFeats:Requires Dodge/Max Weapon Focus >= 1'
      ];
    } else if(feat == 'Herbalist') {
      notes = [
        'magicNotes.herbalistFeature:Create herbal concoctions',
        'validationNotes.herbalistFeatSkills:Requires Profession (Herbalist) >= 4'
      ];
      ...
      notes = [
        ...
        'validationNotes.innateMagicFeatRace:Requires Race =~ Elf|Race =~ Halfling'
      ];
      ...
      notes = [
        ...
        'validationNotes.knifeThrowerFeatRace:Requires Race == Jungle Elf|Race == Snow Elf'
      ];
    } else if(feat == 'Lucky') {
      ...
      notes = [
        ...
        'validationNotes.magicHardenedFeatRace:Requires Race =~ Dwarf|Race =~ Dworg|Race == Orc'
      ];
      rules.defineRule
      ...
      notes = [
        ...
        'validationNotes.ritualMagicFeatFeats:Requires Max Magecraft >= 1/Max Spellcasting >= 1'
      ];
      ...
      notes = [
        ...
        'validationNotes.whisperingAwarenessFeatRace:Requires Race =~ Elfling|Race =~ Elf'
      ];
    } else
      continue;
  ...
  for(var i = 0; i < classes.length; i++) {
    ...
    if(klass.indexOf("Channeler") >= 0 && !channelerDone) {
      spells = [
        ...
        'Faerie Fire:Far Whisper:Feather Fall:Goodberry:Grease:' +
        'Hide From Animals:Hold Portal:Hypnotism:Identify:Jump:' +
        'Lesser Confusion:Lie:Mage Armor:Magic Fang:Magic Missile:' +
        'Magic Mouth:Magic Stone:Magic Weapon:Mount:Nystul\'s Magic Aura:' +
        'Obscuring Mist:Pass Without Trace:Phantom Edge:Produce Flame:' +
        ...
        'Summon Nature\'s Ally I:Tenser\'s Floating Disk:True Strike:' +
        'Undetectable Alignment:Unseen Servant:Ventriloquism',
        'C2:Alter Self:Animal Messenger:Animal Trance:Arcane Lock:Barkskin:' +
        ...
        'Hold Animal:Hypnotic Pattern:Invisibility:Knock:Leomund\'s Trap:' +
        'Lesser Restoration:Levitate:Lifetrap:Locate Object:Magic Mouth:' +
        'Melf\'s Acid Arrow:Minor Image:Mirror Image:Misdirection:' +
        'Nature\'s Revelation:Obscure Object:Owl\'s Wisdom:' +
        'Protection From Arrows:Pyrotechnics:Reduce Animal:Resist Energy:' +
        'Scare:Scorching Ray:Scryer\'s Magic:See Invisibility:Shatter:' +
        'Silence:Silver Blood:Soften Earth And Stone:Sound Burst:' +
        'Spectral Hand:Spider Climb:Summon Monster II:' +
        'Summon Nature\'s Ally II:Summon Swarm:Tasha\'s Hideous Laughter:' +
        ...
        'Leomund\'s Tiny Hut:Lightning Bolt:Magic Circle Against Chaos:' +
        ...
        'Summon Nature\'s Ally III:Tongues:Vampiric Touch:Water Breathing:' +
        'Water Walk:Wind Wall',
        'C4:Air Walk:Animate Dead:Antiplant Shell:Arcane Eye:Bestow Curse:' +
        'Bestow Curse:Bestow Spell:Blight:Charm Monster:Command Plants:' +
        'Confusion:Control Water:Crushing Despair:Cure Critical Wounds:' +
        'Detect Scrying:Dimensional Anchor:Enervation:' +
        'Evard\'s Black Tentacles:Fear:Fire Shield:Fire Trap:Flame Strike:' +
        'Freedom Of Movement:Freedom Of Movement:Giant Vermin:' +
        'Greater Invisibility:Hallucinatory Terrain:Ice Storm:Illusory Wall:' +
        'Leomund\'s Secure Shelter:Lesser Geas:' +
        'Lesser Globe Of Invulnerability:Locate Creature:Mass Enlarge Person:' +
        'Mass Reduce Person:Minor Creation:Modify Memory:' +
        'Otiluke\'s Resilient Sphere:Phantasmal Killer:Polymorph:' +
        'Rainbow Pattern:Rary\'s Mnemonic Enhancer:Reincarnate:Remove Curse:' +
        'Repel Vermin:Restoration:Scrying:Shadow Conjuration:Shout:' +
        'Silver Storm:Solid Fog:Spike Stones:Stone Shape:Stoneskin:' +
        'Summon Monster IV:Summon Nature\'s Ally IV:Wall Of Fire:Wall Of Ice:' +
        'Zone Of Silence',
        'C5:Animal Growth:Atonement:Awaken:Baleful Polymorph:' +
        'Bigby\'s Interposing Hand:Break Enchantment:Call Lightning Storm:' +
        'Cloudkill:Commune With Nature:Cone Of Cold:Contact Other Plane:' +
        ...
        'Leomund\'s Secret Chest:Lesser Planar Binding:' +
        'Magic Circle Against Shadow:Magic Jar:Major Creation:' +
        'Mass Cure Light Wounds:Mind Fog:Mirage Arcana:' +
        ...
        'Shadow Evocation:Song Of Discord:Summon Monster V:' +
        'Summon Nature\'s Ally V:Symbol Of Pain:Symbol Of Sleep:Telekinesis:' +
        ...
        'Antimagic Field:Bigby\'s Forceful Hand:Chain Lightning:' +
        'Circle Of Death:Contingency:Create Undead:Disintegrate:Eyebite:' +
        'Find The Path:Fire Seeds:Flesh To Stone:Geas/Quest:' +
        ...
        'Permanent Image:Planar Binding:Programmed Image:Repel Wood:' +
        'Repulsion:Spellstaff:Stone Tell:Stone To Flesh:Summon Monster VI:' +
        'Summon Nature\'s Ally VI:Symbol Of Fear:Symbol Of Persuasion:' +
        'Sympathetic Vibration:Tenser\'s Transformation:True Seeing:' +
        'Undeath To Death:Veil:Wall Of Iron',
        'C7:Animate Plants:Banishment:Bigby\'s Grasping Hand:Changestaff:' +
        'Control Undead:Control Weather:Creeping Doom:Delayed Blast Fireball:' +
        'Finger Of Death:Fire Storm:Forcecage:Greater Arcane Sight:' +
        'Greater Restoration:Greater Scrying:Greater Shadow Conjuration:Heal:' +
        'Insanity:Mass Cure Serious Wounds:Mass Hold Person:' +
        'Mass Invisibility:Mordenkainen\'s Sword:Power Word, Blind:' +
        'Prismatic Spray:Project Image:Regeneration:Reverse Gravity:' +
        ...
        'C8:Animal Shapes:Antipathy:Bigby\'s Clenched Fist:Binding:Clone:' +
        ...
        'Incendiary Cloud:Iron Body:Mass Charm Monster:' +
        ...
        'Symbol Of Insanity:Sympathy:Temporal Stasis:Trap The Soul:Whirlwind',
        'C9:Astral Projection:Bigby\'s Crushing Hand:Dominate Monster:' +
        ...
        'Power Word, Kill:Prismatic Sphere:Regenerate:Shades:Shambler:' +
        'Shapechange:Soul Bind:Storm Of Vengeance:Summon Monster IX:' +
        'Summon Nature\'s Ally IX:Time Stop:Wail Of The Banshee:Weird'
      ];
      channelerDone = true;
    } else if(klass == 'Legate') {
